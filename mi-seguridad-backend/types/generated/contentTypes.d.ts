...
export interface ApiBrigadistaBrigadista extends Struct.CollectionTypeSchema {
  collectionName: 'brigadistas';
  info: {
    displayName: 'brigadista';
    pluralName: 'brigadistas';
    singularName: 'brigadista';
  };
  options: {
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<['Activo', 'No Activo']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Activo'>;
    foto: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    habilidades: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::brigadista.brigadista'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::brigadista.brigadista': ApiBrigadistaBrigadista;
