        ...
        <div className="bg-black  text-white relative overflow-hidden">
            <div className="container  mx-auto px-6 py-10 text-center relative z-10">
                ...
                <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
                    Siempre debemos estar preparados ante cualquier eventualidad. Sigue esta guía para actuar de manera
                    segura.
                </p>
            </div>
            <div className="container relative  mx-auto max-w-4xl mb-32 z-10">
                ...
                <div className="bg-transparent border-2 border-yellow-500 p-6 rounded-lg">
                    <p className="text-lg text-center text-white">
                        En momentos de crisis, la confusión y el pánico son el mayor riesgo. Los protocolos establecen
                        un plan de acción claro y probado que nos permite actuar con calma, tomar decisiones correctas y
                        minimizar los peligros para todos.
                    </p>
                </div>
