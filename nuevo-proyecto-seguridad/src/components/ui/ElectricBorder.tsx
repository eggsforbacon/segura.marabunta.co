...
// En: src/components/ui/ElectricBorder.tsx
'use client';
...
const updateAnim = () => {
  ...
  const bgGlowStyle: CSSProperties = { ...inheritRadius, transform: 'scale(1.08)', filter: 'blur(32px)', opacity: 0.3, zIndex: -1, background: `linear-gradient(-30deg, ${hexToRgba(color, 0.8)}, transparent, ${color})` };
return (
